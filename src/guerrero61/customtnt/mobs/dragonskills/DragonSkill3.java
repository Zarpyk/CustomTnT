...
public class DragonSkill3 {
	...
	public static final int tntFuseTick = 50;
	public static final int timeBetweenTnT = 10;
	...
	public void Skill3(EnderDragon enderDragon) {
		Main.debug("Skill 3");
				...
				Bukkit.getScheduler()
						.runTaskLater(
								main, () -> tnt.getWorld().createExplosion(tnt.getLocation().getX(),
										tnt.getLocation().getY(), tnt.getLocation().getZ(), 9.0f, true, true),
								tntFuseTick);
				angle += addAngle;
				if (angle >= 360) {
					angle -= 360;
