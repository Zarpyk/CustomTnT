...
public class ServerInfo extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            onlinePlayer.append(Formatter
                    .FText(Formatter.FText("%essentials_afk%", true, player).equals("yes") ? Formatter
                            .FText("[AFK] ", true, player) : "", true, player)).append(player.getName()).append("\n");
        }
        ...
        EmbedBuilder embed = new EmbedBuilder()
                ...
                .addField(Main.getPlayerCount(), (Bukkit.getOnlinePlayers()
                        .size() == 0) ? "No hay nadie jugando" : onlinePlayer.toString(), true).addBlankField(true)
                ...
                .addField("Horas de tormenta", (Objects.requireNonNull(Bukkit.getWorld("world"))
                        .hasStorm() ? StormActionBar.stormTime : "No hay tormenta"), true)
