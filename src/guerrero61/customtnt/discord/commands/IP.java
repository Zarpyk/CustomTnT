...
public class IP extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        EmbedBuilder embed = new EmbedBuilder().setAuthor("IP: " + (Config.getBool(Config.Options.CustomIPEnable) ?
                                                                            Config.getString(
                                                                                    Config.Options.CustomIPIP) :
                                                                            Main.getIp()) +
                                                          (Bukkit.getServer().getPort() == 25565 ? "" :
                                                                   ":" + Bukkit.getServer().getPort()), null,
