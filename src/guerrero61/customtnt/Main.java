...
public class Main extends JavaPlugin {
    ...
    public void skinsRestorerMySqlSetup() {
        try {
            ...
            skinRestorerConnection = DriverManager.getConnection(
                    "jdbc:mysql://" + Config.getString(Config.Options.SkinsRestorerMySQLHost) + ":" +
                    Config.getInt(Config.Options.SkinsRestorerMySQLPort) + "/" +
                    Config.getString(Config.Options.SkinsRestorerMySQLDatabase),
                    Config.getString(Config.Options.SkinsRestorerMySQLUsername),
                    Config.getString(Config.Options.SkinsRestorerMySQLPassword));
